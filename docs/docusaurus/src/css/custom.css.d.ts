declare const styles: {
    ...
    readonly "sb-cat-rules-immutable": string;
    ...
    readonly "sb-preset-functional": string;
    readonly "sb-preset-functional-lite": string;
    readonly "sb-preset-immutable": string;
