...
tags:
  ...
  - adr
  - quality
description: How eslint-plugin-immutable-2 keeps docs tables, preset matrices, and rule metadata aligned through canonical generators.
---
...
- [Rule catalog and docs synchronization chart](https://nick2bad4u.github.io/eslint-plugin-immutable-2/docs/developer/charts/rule-catalog-and-doc-sync)
- [Preset composition and rule matrix chart](https://nick2bad4u.github.io/eslint-plugin-immutable-2/docs/developer/charts/preset-composition-and-rule-matrix)
- [Presets page](https://nick2bad4u.github.io/eslint-plugin-immutable-2/docs/rules/presets)
