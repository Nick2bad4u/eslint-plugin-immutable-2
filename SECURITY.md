...
- GitHub Security Advisory draft: <https://github.com/Nick2bad4u/eslint-plugin-immutable-2/security/advisories/new>
...
- Keep `eslint-plugin-immutable-2`, ESLint, TypeScript, and dependencies updated.
